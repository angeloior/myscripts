...
# config: /etc/default/wildfly.conf NOT USED ?
#
...
#load environment configuration NEW
#. /etc/default/ptv-optima-as
. /usr/local/bin/ptv-optima-as
...
start() {
	...
	echo "Setting max locked memory limit"
	ulimit -l 12703716 
